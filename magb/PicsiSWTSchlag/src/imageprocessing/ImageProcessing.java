...
public class ImageProcessing {
	...
	public ImageProcessing(TwinView views) {
		...
		m_menuItems.add(new ImageMenuItem("&Rotate\tF2", SWT.F2, new Rotate()));
		m_menuItems.add(new ImageMenuItem("&Scale\tF3", SWT.F3, new Scale()));
		m_menuItems.add(new ImageMenuItem("&Filter\tF4", SWT.F4, new Filter()));
		m_menuItems.add(new ImageMenuItem("&GrayScale\tF5", SWT.F5, new GrayScale()));
		m_menuItems.add(new ImageMenuItem("&Dithering\tF6", SWT.F6, new Dithering()));
		m_menuItems.add(new ImageMenuItem("&PatternMatching\tF7", SWT.F7, new PatternMatching()));
