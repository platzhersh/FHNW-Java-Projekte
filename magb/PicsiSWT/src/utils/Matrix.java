...
public class Matrix {
	...
	static public Matrix rotation2d(double phi) {
		double c = Math.cos(Math.toRadians(phi));
		double s = Math.sin(Math.toRadians(phi));
		double[][] rot =
			{
	...
	public static Matrix translation(double a1, double a2) {
...
// ------ Bewegungen des Objekt-Systems
	...
	public static Matrix scale(int f) {
		
		double[][] scale = {{f, 0, 1},{0, f, 1}};
