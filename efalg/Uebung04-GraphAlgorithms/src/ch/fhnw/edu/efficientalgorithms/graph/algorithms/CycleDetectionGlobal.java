 ...
 * @param <E> edge type
 */
public class CycleDetectionGlobal<V extends Vertex, E extends Edge> extends AbstractAlgorithm<V, E>  {

	public CycleDetectionGlobal() {
		super("Cycle Detection (global)", true);
	}
