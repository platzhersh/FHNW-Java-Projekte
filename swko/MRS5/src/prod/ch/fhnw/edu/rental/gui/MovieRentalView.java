...
public class MovieRentalView extends JFrame {
   ...
   */
    ...
    // to shorten the method setMoviePanleLayout
    private JLabel surNameLabel = new JLabel();
    private JLabel firstNameLabel = new JLabel();
    private JLabel rentalDateLabel = new JLabel();
    private JLabel rentalDaysLabel = new JLabel();
    ...
    private void addMoviePanel() {
        ...
        mainPane.insertTab("Movies", new ImageIcon(getClass().getResource("/img/movieLogo.png")), movieCRUDPanel,
                "Movies", MOVIES_TAB_INDEX); // NOI18N
    }
    ...
    private void initMenu() {
        ...
        resetMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_MASK));
        ...
        exitMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, java.awt.event.InputEvent.CTRL_MASK));
    ...
    private void setMoviePanleLayout(JScrollPane movieCRUDScrollPane) {
        ...
        movieCRUDPanelLayout
                .setHorizontalGroup(movieCRUDPanelLayout
                        ...
                        .addGroup(
                                ...
                                movieCRUDPanelLayout.createSequentialGroup().addContainerGap(149, Short.MAX_VALUE)
                                        ...
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(deleteMoviesButton).addGap(18, 18, 18)
                                        .addComponent(saveMoviesButton).addContainerGap())
                        .addGroup(
                                GroupLayout.Alignment.TRAILING,
                                movieCRUDPanelLayout
                                        ...
                                        .addContainerGap()
                                        .addGroup(
                                                movieCRUDPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        .addComponent(priceCatMoviesLabel)
                                                        .addComponent(releaseDateMoviesLabel)
                                                        .addComponent(movieTitleMoviesLabel))
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(
                                                movieCRUDPanelLayout
                                                        .createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        .addComponent(movieTitleMoviesTextField,
                                                        ...
                                                        .addGroup(
                                                                movieCRUDPanelLayout
                                                                        ...
                                                                        .addComponent(priceCatMoviesComboBox,
                                                                                GroupLayout.Alignment.LEADING,
        ...
        movieCRUDPanelLayout.setVerticalGroup(movieCRUDPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(
                        GroupLayout.Alignment.TRAILING,
                        movieCRUDPanelLayout
                                .createSequentialGroup()
                                ...
                                .addGroup(
                                        movieCRUDPanelLayout
                                                ...
                                                .addComponent(movieTitleMoviesLabel)
                                                .addComponent(movieTitleMoviesTextField, GroupLayout.PREFERRED_SIZE,
                                ...
                                .addGroup(
                                        movieCRUDPanelLayout
                                                .createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                .addComponent(releaseDateMoviesLabel)
                                                .addComponent(releaseDateMoviesTextField, GroupLayout.PREFERRED_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(
                                        movieCRUDPanelLayout
                                                .createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                .addComponent(priceCatMoviesLabel)
                                                .addComponent(priceCatMoviesComboBox, GroupLayout.PREFERRED_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(
                                        movieCRUDPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
    ...
    private void initMoviePanel(JScrollPane movieCRUDScrollPane) {
        ...
        movieCRUDTable.setModel(new DefaultTableModel(new Object[][] {{}, {}, {}, {} }, new String[] {}));
    ...
    private void initPriceCategoryField() {
        priceCatMoviesComboBox.setModel(new DefaultComboBoxModel<String>(new String[] {
                "Children", "New Release", "Regular" }));
    ...
    private void setRentMoviePanelLayout() {
        ...
        mainPanelLayout
                .setHorizontalGroup(mainPanelLayout
                        ...
                        .addGroup(
                                GroupLayout.Alignment.TRAILING,
                                mainPanelLayout.createSequentialGroup().addGap(175, 175, 175)
                                        .addComponent(clearAllButton)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGap(18, 18, 18)
                                ...
                                mainPanelLayout
                                        ...
                                        .addGroup(
                                                mainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addComponent(firstNameLabel).addComponent(surNameLabel))
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(
                                                mainPanelLayout
                                                        ...
                                                        .addComponent(rentalDateTextField)
                                                        .addComponent(rentalDaysTextField)).addGap(68, 68, 68)
                        ...
                        mainPanelLayout
                                ...
                                .addGroup(
                                        mainPanelLayout
                                                ...
                                                .addComponent(surNameTextField, GroupLayout.PREFERRED_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                .addComponent(userIdLabel)
                                ...
                                .addGroup(
                                        mainPanelLayout
                                                ...
                                                .addComponent(firstNameTextField, GroupLayout.PREFERRED_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(
                                        mainPanelLayout
                                                ...
                                                .addComponent(rentalDateTextField, GroupLayout.PREFERRED_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(
                                        mainPanelLayout
                                                ...
                                                .addComponent(rentalDaysTextField, GroupLayout.PREFERRED_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(
    ...
    private void addUserPanel() {
        ...
        mainPane.insertTab("Users", new ImageIcon(getClass().getResource("/img/userLogo.png")), userPanel, "Users2",
                USERS_TAB_INDEX); // NOI18N
    ...
    private void addRentalsPanel() {
        ...
        mainPane.insertTab("Rentals", new ImageIcon(getClass().getResource("/img/rentalLogo.png")), rentalsPanel,
                "Rental2", RENTALS_TAB_INDEX); // NOI18N
    ...
    private void initRentMoviePanel() {
        ...
        movieTable.setModel(new DefaultTableModel(dataSet.getMovieListAsObject(false, true), new String[] {
            "Movie ID", "Title", "Release Date", "Is Rented?", "Price Category" }) {
            private static final long serialVersionUID = -5376743898459692217L;
            private Class<?>[] types = new Class[] {Long.class, String.class, Object.class, Boolean.class,
                    Object.class };
    ...
    private void saveMoviesButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!movieTitle.isEmpty()) {
            int ageRatingDummy = 0;
            Movie currMovie = new Movie(movieTitle, date, priceCat, ageRatingDummy);
            if (editMode) {
                int rowCount = movieCRUDTable.getSelectedRow();
    ...
    private void switchToMovies() {
        ...
        movieCRUDTable.setModel(new DefaultTableModel(dataSet.getMovieListAsObject(), new String[] { 
            "Movie ID", "Title", "Release Date", "Is Rented?", "Price Category" }) {
            private static final long serialVersionUID = -8807187529192958223L;
            private Class<?>[] types = new Class[] {java.lang.Integer.class, java.lang.String.class,
    ...
    private void saveRentalButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (isNameNoEmpty(surName, firstName)) {
            ...
            if (newUserCheckBox.isSelected()) {
                Calendar birthDateDummy = Calendar.getInstance();
                birthDateDummy.add(Calendar.YEAR, -18);
                rentalUser = new User(surName, firstName, birthDateDummy);
    ...
    private boolean isUserIdValid(String userId) {
        ...
        try {
            return !userId.isEmpty() && (Long.valueOf(userId).longValue() > 0) && Pattern.matches("\\d*", userId);
        } catch (Exception e) {
            return false;
        }
