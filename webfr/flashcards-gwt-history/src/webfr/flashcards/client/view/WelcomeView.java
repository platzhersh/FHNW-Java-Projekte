...
public class WelcomeView extends Composite implements WelcomePresenter.WelcomeDisplay {
	...
	public WelcomeView() {
		...
		cellList.setSelectionModel(new SingleSelectionModel<Cardbox>());
	}
	...
	@Override
	public Cardbox getSelectedCardBoxes() {
		@SuppressWarnings("unchecked")
		SingleSelectionModel<Cardbox> sm = (SingleSelectionModel<Cardbox>)cellList.getSelectionModel();
		return sm.getSelectedObject();
	}
