...
public class Database {
    ...
    /** SQL command to create table BOOKMARKS. */
    protected static final String CREATE_BOOKMARKS =
        "drop table if exists BOOKMARKS; "
      + "create table BOOKMARKS ("
      + "  Id INTEGER IDENTITY,"
      + "  CardboxId INTEGER,"
      + "  UserId INTEGER,"
      + "  LastLearned TIMESTAMP,"
      + "  CurrentCard INTEGER,"
      + "  CardOrder BLOB"
      + ")";
    
    /** SQL command to create table USERS. */
    protected static final String CREATE_USERS =
        "drop table if exists USERS; "
      + "create table USERS ("
      + "  Id INTEGER IDENTITY,"
      + "  Name VARCHAR(100),"
      + "  PasswordToken INTEGER"
      + ")";
    
    /** SQL command to create a SEQUENCE for primary keys. */
    protected static final String CREATE_SEQUENCE = "CREATE SEQUENCE seq START WITH 10000";
    ...
    private void createDatabaseModel(Connection connection) {
        ...
        try {
            ...
            command(CREATE_USERS, connection);
            command(CREATE_BOOKMARKS, connection);
