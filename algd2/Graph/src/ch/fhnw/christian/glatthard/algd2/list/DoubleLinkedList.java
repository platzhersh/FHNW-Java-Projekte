...
public class DoubleLinkedList<T> {
	...
	public void addHead(T value) {
		Element<T> n = new Element<T>(value);
	...
	public void addTail(T value) {
		Element<T> n = new Element<T>(value);
		if (this.tail == null) this.tail = this.head = n;
		else {
			n.prev = this.tail;
			this.tail.next = n;
		}
	...
	public class DLLIterator implements ListIterator<T>{
		...
		public void remove() {
			...
			if (this.returned != null) {
				if (this.returned.prev == null) list.removeHead();
				else if (this.returned.next == null) list.removeTail();
				else {
					Element<T> tmp = this.returned;
					this.returned.prev.next = tmp.next;
					this.returned.next.prev = tmp.prev;
				}
			}
		}
