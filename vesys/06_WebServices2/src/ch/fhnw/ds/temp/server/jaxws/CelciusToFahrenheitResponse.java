...
@XmlRootElement(name = "celciusToFahrenheitResponse", namespace = "http://server.temp.ds.fhnw.ch/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "celciusToFahrenheitResponse", namespace = "http://server.temp.ds.fhnw.ch/")
